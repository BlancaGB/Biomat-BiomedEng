...
En *1976* se comenzó a aplicar la regulación de la /Food and Drug Administration/ (FDA) de Estados Unidos, para cualquier dispositivo médico que quisiera entrar al mercado. En consecuencia, se retiraron algunos de los materiales poliméricos empleados hasta la fechas, mientras que otros polímeros se terminaron posicionando como las soluciones más habituales para aplicaciones biomédicas. En la actualidad, el campo de materiales poliméricos para biomedicina se centra en mejorar el comportamiento biocompatible de los materiales poliméricos en el cuerpo. 
