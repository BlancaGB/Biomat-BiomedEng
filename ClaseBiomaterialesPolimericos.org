...
*** 1.3 Polímeros, ¿una oportunidad terapeútica en valvulopatías? 
...
*Composición de las válvulas*. Las válvulas están formadas por unas membranas finas que son resistentes a la presión y procuran la apertura y cierre de las aurículas y los ventrículos. Están constituidas por tejido endotelial, que es el mismo que recubre el interior de los vasos sanguíneos y el corazón. 

*Valvulopatías*. En determinadas ocasiones una o varias válvulas dejan de funcionar correctamente, y a estas enfermedades se las denomina valvulopatías. Las válvulas pueden dañarse por infecciones, traumatismos, por envejcimiento u otras causas, causando una disminución de la apertura (estenosis), el cierre insuficiente (insuficiencia) o una combinación de las mismas  

*Terapias basadas en el empleo de válvulas artificiales*. Para sustituir las válvulas existen terapias que se basan en el empleo de dos tipos de válvulas: 
  ...
  - L*as válvulas mecánicas* están hechas de metales, cerámicas y plásticos. Hay diferentes tipos de válvulas mecánicas, pero es preferible utilizar aquellas que tienen dos valvas (bivalvas); existen válvulas de una sola valva o disco. La ventaja de las válvulas mecánicas es que son muy duraderas debido a los materiales con que están construidas. Sin embargo, estos materiales pueden causar coágulos dentro del corazón, por eso los pacientes portadores de estas prótesis mecánicas deben recibir un tratamiento anticoagulante toda la vida (tipo acenocumarol, de nombre comercial sintrom). Además, muchas veces son demasiado rígidas y terminan generando daño tisular.
   
Todavía, sin embargo, no existe ninguna terapia basada en válvulas artificiales que combine las prestaciones mecánicas de las válvulas biológicas y la durabilidad de las válvulas mecánicas. ¿Podrían usarse los materiales poliméricos sintéticos para este tipo de terapia? 

   #+ATTR_LATEX: :height 0.05\textheight
[[file:Figs/Valvulas.png]]

** 2. Conceptos básicos: definición, estructura y composición química 
