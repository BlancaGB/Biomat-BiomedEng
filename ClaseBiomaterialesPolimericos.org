...
Un polímero es una macromolécula orgánica relativamente grande (10^{4}- 10^{6} g/mol) compuesta por una catenación de múltiples unidades pequeñas que se repiten. A las pequeñas unidades que se repiten se les denomina *monómero*, y la unidad que se repite a lo largo de la cadena se llama *unidad estructural repetitiva*. 
...
** 3. Síntesis: tipos de polimerización
