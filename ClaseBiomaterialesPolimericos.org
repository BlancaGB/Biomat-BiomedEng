...
¿Qué ventajas ofrecen los materiales poliméricos sintéticos respecto a otras familias de materiales en biomedicina? 

1. Versatilidad en su comportamiento mecánico. Los polímeros son posiblemente la familia de materiales que ofrecen un mayor rango de propiedades mecánicas semejantes a las de los tejidos naturales. Esto se debe a la microestructura macromolecular de los polímeros, la cual les otorga una serie propiedades biomiméticas que se utilizan a conveniencia para remplazar diversos tejidos. Por ejemplo, el módulo elático y la resistencia a fractura de un polímero puede modularse a través de la composición de los mismos, y proporcionar así propiedades mecánicas próximas a las de los materiales del cuerpo. 

En la figura se representa una comparación del módulo elástico de metales, cerámicos y polímeros, así como de tejidos duros y blandos del cuerpo. El módulo elástico puede reducirse disminuyendo el peso molecular del material o expandiendo el polímero para que sea más poroso. Esta variabilidad controlada de las propiedades mecánicas hace que superen a los cerámios o los metales, que suelen ser mucho más rígidos que los materiales biológicos adyacentes. En la tabla se ofrece un resumen de los polímeros que más se emplean en ortopedia, odontología e implantes cardiovasculares y de tejidos blandos. 

https://raw.githubusercontent.com/BlancaGB/Biomaterials/main/Figs/PropMecanicas.png
